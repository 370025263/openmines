...
class ShortestTripDispatcher(BaseDispatcher):
    ...
    def give_init_order(self, truck: "Truck", mine: "Mine") -> int:
        ...
        load_available_time = now_time + np.array([load_site.est_waiting_time for load_site in mine.load_sites])
    ...
    def give_haul_order(self, truck: "Truck", mine: "Mine") -> int:
        ...
        dump_available_time = now_time + np.array([dump_site.est_waiting_time for dump_site in mine.dump_sites])
        ...
        assert mine.dump_sites[0].dump_site_productivity != 0, "dump_site_productivity is 0"
        unloading_time = np.array([dump_site[0].dump_time for dump_site in mine.dump_sites])
